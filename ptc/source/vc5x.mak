# Visual C++ 5.x makefile for PTC

LIBDIR  = ..\library\win32\vc5.x

!IF "$(CFG)"=="release" || "$(CFG)"==""
!MESSAGE Building PTC: Visual C++ 5.x release.lib
CPPOPTS = -c -MT -WX -W3 -O2 -Ox -D "WIN32" -D "NDEBUG" -D "_WINDOWS" -D "_MT" -nologo
LIBNAME = $(LIBDIR)\release.lib
!ENDIF 

!IF "$(CFG)"=="debug"
!MESSAGE Building PTC: Visual C++ 5.x debug.lib
...
LIBCMD  = link -lib -out:$(LIBNAME) @vc5x.cmd
