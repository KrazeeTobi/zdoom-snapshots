...
void P_PlayerInSpecialSector (player_t *player, sector_t * sector)
{
	...
	// For 3D-floors the sector is passed as a parameter!
	if (!sector)
	{
	...
	if (special >= dLight_Flicker && special <= 255)
	{
		...
		case dDamage_End:
			...
			{
				G_ExitLevel(0, false);	// Exit immediately if God Mode on!
				break;
			}
	...
	// [GrafZahl] This code is not only redundant (see P_PlayerOnSpecialFlat),
	// it also contains a bug and inflicts damage far too often!
	/*
