...
CVAR (Bool, wi_sucks, true, CVAR_ARCHIVE)		// this is for those of us who absolutely can't stand the 'sucks'!
...
void WI_drawTime (int x, int y, int t, bool no_sucks=false)
{
	...
	if (no_sucks || !wi_sucks || (t <= 61*59 || gameinfo.gametype != GAME_Doom))
	{
		int hours = t / 3600;
		t -= hours * 3600;
		int minutes = t / 60;
