...
bool FWarp2Texture::CheckModified ()
{
	return r_FrameTime != GenTime;
}

const BYTE *FWarp2Texture::GetPixels ()
{
	DWORD time = r_FrameTime;
...
const BYTE *FWarp2Texture::GetColumn (unsigned int column, const Span **spans_out)
{
	DWORD time = r_FrameTime;
